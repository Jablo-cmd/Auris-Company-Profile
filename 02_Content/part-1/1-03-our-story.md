...
words_target: 420
words_actual: 418
figures: ["fig-1.1-milestone-timeline"]
tables: []
icons: ["fa-timeline"]
...
> Why the company exists, what it has built, and what it learned in the process.
...
organisation's actual operating reality and the software proposed to improve it. That gap is where
requirements are written from assumptions rather than observation, where systems are accepted because
they match a specification rather than because they work, and where implementations are declared
complete at precisely the moment the difficult part begins.

Closing that gap requires a company to be organised differently. It has to be willing to spend
unbilled time understanding a process before quoting to change it. It has to keep the same people
involved from discovery through to support, rather than handing work across internal boundaries. And
