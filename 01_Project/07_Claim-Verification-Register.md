...
| CVR-011 | legacy legacy platform-service taxonomy section | "We Auris-owned software platforms including Funda360 and Sebetsa" | Evidence the platforms exist and are in active operation (screenshot, deployment record) | Product/platform owner | Unverified | High | — |
| CVR-012 | 2.9 Engagement models | Current engagement models genuinely offered | Sample contracts or rate cards evidencing each of the five models in actual use | Commercial/finance | Unverified | Medium | — |
